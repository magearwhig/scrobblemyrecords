...
Active plans and feature specs. Completed plans are in `done/`. Cancelled plans are in `cancelled/`.
...
| marketplace-upgrade-plan.md | Backlog -- Effort C (#19 + #20) from backlog shark tank |
