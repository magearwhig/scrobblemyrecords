...
const HistoryPage: React.FC = () => {
  ...
  const [selectedSession, setSelectedSession] = useState<ScrobbleSession | null>(null);
  ...
  if (!authStatus.lastfm.authenticated) {
    return (
      <div className="card">
        ...
        <p>Please authenticate with Last.fm first to view your scrobbling history.</p>
            ...
            <div key={session.id} className="card">
              ...
              {selectedSession?.id === session.id && (
                <div style={{ 
                  ...
                  <h4 style={{ marginTop: 0, marginBottom: '1rem' }}>Session Details</h4>
                  ...
                  <div style={{ 
                    ...
                    {session.tracks.map((track, index) => (
                      <div
                        ...
                        style={{
                          padding: '0.75rem',
                          borderBottom: index < session.tracks.length - 1 ? '1px solid #f0f0f0' : 'none'
                        }}
                      >
                        ...
                        {track.timestamp && (
                          <div style={{ fontSize: '0.75rem', color: '#999' }}>
                            Scrobbled: {formatLocalTimeClean(track.timestamp * 1000)}
                          </div>
                        )}
                      </div>
                    ))}
